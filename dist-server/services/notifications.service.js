 ...
 */
export async function checkStockAndNotify(productId) {
...
export async function listNotificationsForUser(userId, unreadOnly = false) {
    const where = unreadOnly
        ? and(or(eq(schema.notifications.userId, userId), isNull(schema.notifications.userId)), eq(schema.notifications.isRead, false))
